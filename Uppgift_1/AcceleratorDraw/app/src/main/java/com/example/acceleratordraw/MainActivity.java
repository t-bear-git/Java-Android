...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initiating Accelerometer from SensorManager.
        mSensorManager = (SensorManager) getSystemService(SENSOR_SERVICE);
        mAccelerometer = mSensorManager.getDefaultSensor(Sensor.TYPE_ACCELEROMETER);

        // Initiating view to be used instead of layout.
        mAnimatedView = new AnimatedView(this);
        //Set the content to the created view.
    ...
    public class AnimatedView extends View {
        ...
        public void onSensorEvent (SensorEvent event) {
            ...
            // Used to make sure the circle stays within the view.
            // Max values that can be drawed is the size of the view + the size of the circle.
        ...
        protected void onDraw(Canvas canvas) {
            ...
            // Calls invalidate each time, so that the view continuously draws.
            invalidate();
        }
    }
}